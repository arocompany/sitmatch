package com.nex.search.textInstagramService;
...
@Lazy
public class SearchTextUsInstagramService {
    ...
    public void search(byte tsiInstagram, String tsiType, SearchInfoEntity insertResult, String folder,
